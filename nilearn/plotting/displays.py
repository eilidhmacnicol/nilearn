...
class CutAxes(BaseAxes):
    ...
    def _add_markers(self, marker_coords, marker_color, marker_size, marker_labels, **kwargs):
        """Plot markers
        ...
        if marker_labels is not None:
            for i, txt in enumerate(marker_labels):
                self.ax.annotate(
                    txt,
                    (round(xdata[i], 1), round(ydata[i], 1)),
                    fontsize='xx-small',
                    color='white', zorder=3000)
...
class BaseSlicer(object):
    ...
    def add_graph(self, adjacency_matrix, node_coords,
                  ...
                  node_labels=None, edge_cmap=cm.bwr,
        ...
        for ax in self.axes.values():
            ...
            if line_coords:
                ax._add_lines(line_coords, adjacency_matrix_values, edge_cmap,
                              ...
                              directed=(not symmetric), **edge_kwargs)
